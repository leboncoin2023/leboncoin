...
class Generated04c586c584ca0a67be4ef56c772f62e9 extends \App\Document\User implements \ProxyManager\Proxy\GhostObjectInterface
{
    /**
    ...
    private static $signature04c586c584ca0a67be4ef56c772f62e9 = '';
    ...
    private function callInitializer6c7a1($methodName, array $parameters)
    {
        ...
        $nonReferenceableProperties = new class() {
            public ?string $username_on_App_Document_User;
        };
        $properties = [
            '' . "\0" . 'App\\Document\\User' . "\0" . 'username' => & $nonReferenceableProperties->username_on_App_Document_User,
        ];



        $result = $this->initializer22cc9->__invoke($this, $methodName, $parameters, $this->initializer22cc9, $properties);
        static $cacheAssignApp_Document_User;

        $cacheAssignApp_Document_User ?? $cacheAssignApp_Document_User = \Closure::bind(function ($instance, $nonReferenceableProperties) {
            isset($nonReferenceableProperties->username_on_App_Document_User) && $instance->username = $nonReferenceableProperties->username_on_App_Document_User;
        }, null, 'App\\Document\\User');

        $cacheAssignApp_Document_User($this, $nonReferenceableProperties);
